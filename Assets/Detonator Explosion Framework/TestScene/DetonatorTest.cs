...
public class DetonatorTest : MonoBehaviour
{
    ...
    private void OnGUI()
    {
        ...
        {
            UnityEngine.Camera.main.transform.position = new Vector3(0, 0, -7);
            UnityEngine.Camera.main.transform.eulerAngles = new Vector3(13.5f, 0, 0);
        }
        if (GUILayout.Button("Camera Near"))
        {
            UnityEngine.Camera.main.transform.position = new Vector3(0, -8.664466f, 31.38269f);
            UnityEngine.Camera.main.transform.eulerAngles = new Vector3(1.213462f, 0, 0);
        }
